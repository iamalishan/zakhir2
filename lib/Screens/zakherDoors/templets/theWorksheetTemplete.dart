...
class TheWorksheetCard extends StatefulWidget {
  const TheWorksheetCard({ Key? key }) : super(key: key);

  @override
  State<TheWorksheetCard> createState() => _TheWorksheetCardState();
}

class _TheWorksheetCardState extends State<TheWorksheetCard> {
  @override
  Widget build(BuildContext context) {
        ...
        SizedBox(
          ...
          Padding(
           ...
           StreamBuilder<QuerySnapshot<Map<String, dynamic>>?>(
            stream: FirebaseFirestore.instance.collection('userData/uid/cards').where('cardType' , isEqualTo: 'worksheet').snapshots(),
    ...
    MaterialPageRoute(builder: (context) =>  CardDetailScreen( id: snapshot.data?.docs[index].id,))
          ...
          Padding(
            ...
            child: InkWell(
                onTap: (){
                        Navigator.pushNamed(context, '/TheWorksheetTemplete');
          },
...
class TheWorksheetTemplete extends StatefulWidget {
  const TheWorksheetTemplete({Key? key}) : super(key: key);

  @override
  State<TheWorksheetTemplete> createState() => _TheWorksheetTempleteState();
}

class _TheWorksheetTempleteState extends State<TheWorksheetTemplete> {
