...
class TheReviewerCards extends StatefulWidget {
  const TheReviewerCards({ Key? key }) : super(key: key);

  @override
  State<TheReviewerCards> createState() => _TheReviewerCardsState();
}

class _TheReviewerCardsState extends State<TheReviewerCards> {
  @override
  Widget build(BuildContext context) {
        ...
        SizedBox(
          ...
          Padding(
           ...
           StreamBuilder<QuerySnapshot<Map<String, dynamic>>?>(
            stream: FirebaseFirestore.instance.collection('userData/uid/cards').where('cardType' , isEqualTo: 'thereviewer').snapshots(),
    ...
    MaterialPageRoute(builder: (context) =>  CardDetailScreen( id: snapshot.data?.docs[index].id,))
          ...
          Padding(
            ...
            child: InkWell(
                onTap: (){
                        Navigator.pushNamed(context, '/TheReviewerTemplete');
          },
...
class TheReviewerTemplete extends StatefulWidget {
  const TheReviewerTemplete({Key? key}) : super(key: key);

  @override
  State<TheReviewerTemplete> createState() => _TheReviewerTempleteState();
}

class _TheReviewerTempleteState extends State<TheReviewerTemplete> {
            ...
            Padding(
              ...
              child: Container(
                ...
                child: RaisedButton(
                    ...
                    child:
                        Text(LocaleKeys.ElectronicPreparation_Thereviewer.tr())),
              ),
            ),
            // Padding(
            //   padding: const EdgeInsets.all(8.0),
