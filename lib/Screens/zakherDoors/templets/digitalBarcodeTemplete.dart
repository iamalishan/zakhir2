...
class DigitalBarcodeCards extends StatefulWidget {
  const DigitalBarcodeCards({ Key? key }) : super(key: key);

  @override
  State<DigitalBarcodeCards> createState() => _DigitalBarcodeCardsState();
}

class _DigitalBarcodeCardsState extends State<DigitalBarcodeCards> {
  @override
  Widget build(BuildContext context) {
        ...
        SizedBox(
          ...
          Padding(
           ...
           StreamBuilder<QuerySnapshot<Map<String, dynamic>>?>(
            stream: FirebaseFirestore.instance.collection('userData/uid/cards').where('cardType' , isEqualTo: 'digitalBarcode').snapshots(),
    ...
    MaterialPageRoute(builder: (context) =>  CardDetailScreen( id: snapshot.data?.docs[index].id,))
          ...
          Padding(
            ...
            child: InkWell(
                onTap: (){
                        Navigator.pushNamed(context, '/DigitalBarcodeTemplete');
          },
...
class DigitalBarcodeTemplete extends StatefulWidget {
  const DigitalBarcodeTemplete({Key? key}) : super(key: key);

  @override
  State<DigitalBarcodeTemplete> createState() => _DigitalBarcodeTempleteState();
}

class _DigitalBarcodeTempleteState extends State<DigitalBarcodeTemplete> {
            ...
            Padding(
              ...
              child: Container(
                ...
                child: RaisedButton(
                    ...
                    child: Text(
                        LocaleKeys.ElectronicPreparation_Digitalbarcode.tr())),
              ),
            ),
            // Padding(
            //   padding: const EdgeInsets.all(8.0),
