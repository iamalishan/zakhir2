...
class BrowsingStartegyCards extends StatefulWidget {
  const BrowsingStartegyCards({ Key? key }) : super(key: key);

  @override
  State<BrowsingStartegyCards> createState() => _BrowsingStartegyCardsState();
}

class _BrowsingStartegyCardsState extends State<BrowsingStartegyCards> {
  @override
  Widget build(BuildContext context) {
        ...
        SizedBox(
          ...
          Padding(
           ...
           StreamBuilder<QuerySnapshot<Map<String, dynamic>>?>(
            stream: FirebaseFirestore.instance.collection('userData/uid/cards').where('cardType' , isEqualTo: 'browsing').snapshots(),
    ...
    MaterialPageRoute(builder: (context) =>  CardDetailScreen( id: snapshot.data?.docs[index].id,))
          ...
          Padding(
            ...
            child: InkWell(
                onTap: (){
                        Navigator.pushNamed(context, '/BrowsingTemplete');
          },
...
class BrowsingTemplete extends StatefulWidget {
  const BrowsingTemplete({Key? key}) : super(key: key);

  @override
  State<BrowsingTemplete> createState() => _BrowsingTempleteState();
}

class _BrowsingTempleteState extends State<BrowsingTemplete> {
            ...
            Padding(
              ...
              child: Container(
                ...
                child: RaisedButton(
                    ...
                    child:
                        Text(LocaleKeys.ElectronicPreparation_Browsingstrategy.tr())),
              ),
            ),
            // Padding(
            //   padding: const EdgeInsets.all(8.0),
