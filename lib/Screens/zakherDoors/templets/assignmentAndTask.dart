...
class AssignmentCards extends StatefulWidget {
  const AssignmentCards({ Key? key }) : super(key: key);

  @override
  State<AssignmentCards> createState() => _AssignmentCardsState();
}
  ...
  Widget build(BuildContext context) {
        ...
        SizedBox(
          ...
          Padding(
           ...
           StreamBuilder<QuerySnapshot<Map<String, dynamic>>?>(
            stream: FirebaseFirestore.instance.collection('userData/uid/cards').where('cardType' , isEqualTo: 'assignment').snapshots(),
    ...
    MaterialPageRoute(builder: (context) =>  CardDetailScreen( id: snapshot.data?.docs[index].id,))
          ...
          Padding(
            ...
            child: InkWell(
                onTap: (){
                        Navigator.pushNamed(context, '/AssignmentAndTaskTemplate');
          },
